...
#include <arm_neon.h>
#define __m128          float32x4_t     // 4 x 32 bits floats in a vector

#define _mm_load_ps     vld1q_f32       // load float vector from memory

#define _mm_store_ps    vst1q_f32       // store float vector to memory

#define _mm_add_ps      vaddq_f32       // add float vectors

#define _mm_sub_ps      vsubq_f32

#define _mm_mul_ps      vmulq_f32       // add float vectors
